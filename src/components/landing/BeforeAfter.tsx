...
const BEFORE: Task[] = [
  ...
  { icon: FileText, title: "Review invoices", desc: "supplier, dates, line items, totals", time: "10–20 min" },
  { icon: Keyboard, title: "Data entry", desc: "codes, references, descriptions, dates", time: "10–15 min" },
  { icon: Search, title: "Duplicate checks", desc: "cross-checking past documents by hand", time: "5–10 min" },
...
const AFTER: Task[] = [
  ...
  { icon: ShieldCheck, title: "Duplicate detection", desc: "checks run in the background", time: "Automatic" },
