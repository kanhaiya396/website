import{w as B,h as o,z as Z,D as W,k as e,P as w,G as ee,R as te,I as se,J as k,K as ae,L as re,M as R,o as u,l as ie,H as ne,m as T,B as p,q as A,Z as oe,y as C,C as j,N as de,O as ce,A as le,v as me,Q as ue}from"./index-Droy0GSa.js";import{b as pe}from"./seo-CF-g2gvc.js";import{B as x,d as P,G as xe,C as f,c as g,R as he}from"./badge-DMawsCZ2.js";import"./pptxgenjs-CjJrydW0.js";import"./jspdf-CqVPTroE.js";/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const fe=B("BookOpen",[["path",{d:"M12 7v14",key:"1akyts"}],["path",{d:"M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z",key:"ruj8y"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const ge=B("ExternalLink",[["path",{d:"M15 3h6v6",key:"1q9fwt"}],["path",{d:"M10 14 21 3",key:"gplh6r"}],["path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6",key:"a6xqqp"}]]);/**
 * @license lucide-react v0.462.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const S=B("Key",[["path",{d:"m15.5 7.5 2.3 2.3a1 1 0 0 0 1.4 0l2.1-2.1a1 1 0 0 0 0-1.4L19 4",key:"g0fldk"}],["path",{d:"m21 2-9.6 9.6",key:"1j0ho8"}],["circle",{cx:"7.5",cy:"15.5",r:"5.5",key:"yqb3hr"}]]);var _="Tabs",[ye]=re(_,[R]),O=R(),[be,q]=ye(_),D=o.forwardRef((t,a)=>{const{__scopeTabs:r,value:i,onValueChange:n,defaultValue:c,orientation:s="horizontal",dir:m,activationMode:y="automatic",...b}=t,l=Z(m),[d,h]=W({prop:i,onChange:n,defaultProp:c??"",caller:_});return e.jsx(be,{scope:r,baseId:ee(),value:d,onValueChange:h,orientation:s,dir:l,activationMode:y,children:e.jsx(w.div,{dir:l,"data-orientation":s,...b,ref:a})})});D.displayName=_;var L="TabsList",M=o.forwardRef((t,a)=>{const{__scopeTabs:r,loop:i=!0,...n}=t,c=q(L,r),s=O(r);return e.jsx(te,{asChild:!0,...s,orientation:c.orientation,dir:c.dir,loop:i,children:e.jsx(w.div,{role:"tablist","aria-orientation":c.orientation,...n,ref:a})})});M.displayName=L;var G="TabsTrigger",$=o.forwardRef((t,a)=>{const{__scopeTabs:r,value:i,disabled:n=!1,...c}=t,s=q(G,r),m=O(r),y=K(s.baseId,i),b=U(s.baseId,i),l=i===s.value;return e.jsx(se,{asChild:!0,...m,focusable:!n,active:l,children:e.jsx(w.button,{type:"button",role:"tab","aria-selected":l,"aria-controls":b,"data-state":l?"active":"inactive","data-disabled":n?"":void 0,disabled:n,id:y,...c,ref:a,onMouseDown:k(t.onMouseDown,d=>{!n&&d.button===0&&d.ctrlKey===!1?s.onValueChange(i):d.preventDefault()}),onKeyDown:k(t.onKeyDown,d=>{[" ","Enter"].includes(d.key)&&s.onValueChange(i)}),onFocus:k(t.onFocus,()=>{const d=s.activationMode!=="manual";!l&&!n&&d&&s.onValueChange(i)})})})});$.displayName=G;var V="TabsContent",F=o.forwardRef((t,a)=>{const{__scopeTabs:r,value:i,forceMount:n,children:c,...s}=t,m=q(V,r),y=K(m.baseId,i),b=U(m.baseId,i),l=i===m.value,d=o.useRef(l);return o.useEffect(()=>{const h=requestAnimationFrame(()=>d.current=!1);return()=>cancelAnimationFrame(h)},[]),e.jsx(ae,{present:n||l,children:({present:h})=>e.jsx(w.div,{"data-state":l?"active":"inactive","data-orientation":m.orientation,role:"tabpanel","aria-labelledby":y,hidden:!h,id:b,tabIndex:0,...s,ref:a,style:{...t.style,animationDuration:d.current?"0s":void 0},children:h&&c})})});F.displayName=V;function K(t,a){return`${t}-trigger-${a}`}function U(t,a){return`${t}-content-${a}`}var ve=D,z=M,H=$,Y=F;const je=ve,X=o.forwardRef(({className:t,...a},r)=>e.jsx(z,{ref:r,className:u("inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 text-muted-foreground",t),...a}));X.displayName=z.displayName;const N=o.forwardRef(({className:t,...a},r)=>e.jsx(H,{ref:r,className:u("inline-flex items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",t),...a}));N.displayName=H.displayName;const Q=o.forwardRef(({className:t,...a},r)=>e.jsx(Y,{ref:r,className:u("mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",t),...a}));Q.displayName=Y.displayName;const J={GET:"bg-emerald-500/15 text-emerald-400 border-emerald-500/30",POST:"bg-blue-500/15 text-blue-400 border-blue-500/30",PUT:"bg-amber-500/15 text-amber-400 border-amber-500/30",DELETE:"bg-red-500/15 text-red-400 border-red-500/30"},v=[{id:"upload-document",method:"POST",path:"/v1/documents",title:"Upload Document",description:"Upload an invoice, receipt, or expense document for AI-powered extraction. Supports PDF, JPEG, PNG, and HEIC formats up to 25 MB.",category:"Documents",requestBody:`{
...
}`,params:[{name:"vat_number",type:"string",required:!0,description:"VAT registration number"},{name:"country_code",type:"string",required:!1,description:"ISO country code (auto-detected if prefixed)"}]}],Ne=[...new Set(v.map(t=>t.category))],E={curl:t=>{const a=t.method==="GET"?"":` -X ${t.method}`,r=t.requestBody?` \\
